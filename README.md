...
![Powerful Animations sidebar showing all three panels](images/sidebar-full.png)
...
![SVG Tools panel with command cards](images/sidebar-svg-tools.png)

![SVG Preview panel open in split view with Studio Bar visible](images/preview-panel-split-view.png)

![With() formula file alongside the live preview with variable defaults applied](images/preview-with-formula.png)

![Studio Bar close-up showing playback controls and frosted glass effect](images/studio-bar.png)
